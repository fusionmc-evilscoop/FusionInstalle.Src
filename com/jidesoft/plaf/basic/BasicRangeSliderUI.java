...
/*     */   {
/*  31 */     return new BasicRangeSliderUI((JSlider)slider);
/*     */   }
/*     */ 
...
/*     */     {
/* 128 */       if (!BasicRangeSliderUI.this.slider.isEnabled()) {
/* 129 */         return;
/*     */       }
/*     */ 
/* 132 */       if (BasicRangeSliderUI.this.slider.isRequestFocusEnabled()) {
/* 133 */         BasicRangeSliderUI.this.slider.requestFocus();
/*     */       }
/*     */ 
/* 136 */       this.handle = BasicRangeSliderUI.this.getMouseHandle(e.getX(), e.getY());
/* 137 */       BasicRangeSliderUI.this.setMousePressed(this.handle);
/*     */ 
/* 139 */       if ((this.handle == 2) || (this.handle == 1) || (this.handle == 4)) {
/* 140 */         this.handleOffset = (BasicRangeSliderUI.this.slider.getOrientation() == 1 ? e.getY() - BasicRangeSliderUI.this.yPositionForValue(((RangeSlider)BasicRangeSliderUI.this.slider).getLowValue()) : e.getX() - BasicRangeSliderUI.this.xPositionForValue(((RangeSlider)BasicRangeSliderUI.this.slider).getLowValue()));
/*     */ 
/* 144 */         this.mouseStartLocation = (BasicRangeSliderUI.this.slider.getOrientation() == 1 ? e.getY() : e.getX());
/*     */ 
/* 146 */         BasicRangeSliderUI.this.slider.getModel().setValueIsAdjusting(true);
/*     */       }
/* 148 */       else if ((this.handle == 5) || (this.handle == 6)) {
/* 149 */         this._listener.mousePressed(e);
/* 150 */         BasicRangeSliderUI.this.slider.putClientProperty("RangeSlider.mousePosition", null);
/*     */       }
/*     */     }
/*     */ 
/*     */     public void mouseDragged(MouseEvent e)
/*     */     {
/* 159 */       if (!BasicRangeSliderUI.this.slider.isEnabled()) {
/* 160 */         return;
/*     */       }
/*     */ 
/* 163 */       int newLocation = BasicRangeSliderUI.this.slider.getOrientation() == 1 ? e.getY() : e.getX();
/*     */ 
/* 165 */       int newValue = BasicRangeSliderUI.this.slider.getOrientation() == 1 ? BasicRangeSliderUI.this.valueForYPosition(newLocation) : BasicRangeSliderUI.this.valueForXPosition(newLocation);
/*     */ 
/* 167 */       if (newValue < BasicRangeSliderUI.this.slider.getModel().getMinimum()) {
/* 168 */         newValue = BasicRangeSliderUI.this.slider.getModel().getMinimum();
/*     */       }
/*     */ 
/* 171 */       if (newValue > BasicRangeSliderUI.this.slider.getModel().getMaximum()) {
/* 172 */         newValue = BasicRangeSliderUI.this.slider.getModel().getMaximum();
/*     */       }
/*     */ 
...
/*     */       }
/*     */ 
/* 187 */       RangeSlider rangeSlider = (RangeSlider)BasicRangeSliderUI.this.slider;
...
/* 194 */         break;
/*     */       case 4:
/* 196 */         if (!((RangeSlider)BasicRangeSliderUI.this.slider).isRangeDraggable()) break;
/* 197 */         int delta = BasicRangeSliderUI.this.slider.getOrientation() == 1 ? BasicRangeSliderUI.this.valueForYPosition(newLocation - this.handleOffset) - rangeSlider.getLowValue() : BasicRangeSliderUI.this.valueForXPosition(newLocation - this.handleOffset) - rangeSlider.getLowValue();
/*     */ 
...
/* 209 */         BasicRangeSliderUI.this.offset(delta);
/*     */       case 3:
/*     */       }
/*     */     }
/*     */ 
...
/*     */     {
/* 221 */       BasicRangeSliderUI.this.slider.getModel().setValueIsAdjusting(false);
/* 222 */       BasicRangeSliderUI.this.setMouseReleased(this.handle);
...
/*     */ 
/* 229 */       if (BasicRangeSliderUI.this.slider.getCursor() != cursor)
/* 230 */         BasicRangeSliderUI.this.slider.setCursor(cursor);
/*     */     }
/*     */ 
/*     */     public void mouseMoved(MouseEvent e)
/*     */     {
/* 239 */       if (!BasicRangeSliderUI.this.slider.isEnabled()) {
/* 240 */         return;
/*     */       }
/*     */ 
/* 243 */       int handle = BasicRangeSliderUI.this.getMouseHandle(e.getX(), e.getY());
/* 244 */       BasicRangeSliderUI.this.setMouseRollover(handle);
/* 245 */       switch (handle) {
/*     */       case 1:
/* 247 */         setCursor(0);
/* 248 */         break;
...
/* 251 */         break;
/*     */       case 4:
/* 253 */         if (((BasicRangeSliderUI.this.slider instanceof RangeSlider)) && (((RangeSlider)BasicRangeSliderUI.this.slider).isRangeDraggable())) {
/* 254 */           setCursor(13);
/*     */         }
/*     */         else {
/* 257 */           setCursor(0);
...
/* 273 */         BasicRangeSliderUI.this.slider.getModel().setValue(BasicRangeSliderUI.this.slider.getModel().getMinimum());
/* 274 */         BasicRangeSliderUI.this.slider.getModel().setExtent(BasicRangeSliderUI.this.slider.getModel().getMaximum() - BasicRangeSliderUI.this.slider.getModel().getMinimum());
/* 275 */         BasicRangeSliderUI.this.slider.repaint();
/*     */       }
/*     */     }
/*     */ 
/*     */     public void mouseEntered(MouseEvent e)
/*     */     {
/* 284 */       BasicRangeSliderUI.this.hover = true;
/* 285 */       BasicRangeSliderUI.this.slider.repaint();
/*     */     }
/*     */ 
/*     */     public void mouseExited(MouseEvent e)
/*     */     {
/* 293 */       BasicRangeSliderUI.this.hover = false;
/* 294 */       BasicRangeSliderUI.this.slider.repaint();
/* 295 */       setCursor(0);
/*     */     }
/*     */   }
/*     */ }
 ...
 * Qualified Name:     com.jidesoft.plaf.basic.BasicRangeSliderUI
