...
public final class PlatformDefaults
{
  ...
  {
    return (UnitValue)HOR_DEFS.get(paramString);
  }

  public static UnitValue getUnitValueY(String paramString)
  {
    return (UnitValue)VER_DEFS.get(paramString);
  }
  ...
  public static final void setUnitValue(String[] paramArrayOfString, UnitValue paramUnitValue1, UnitValue paramUnitValue2)
  {
    for (int i = 0; i < paramArrayOfString.length; i++)
    {
      ...
      if (paramUnitValue1 != null)
        HOR_DEFS.put(str, paramUnitValue1);
      if (paramUnitValue2 == null)
        continue;
      VER_DEFS.put(str, paramUnitValue2);
    }
    MOD_COUNT += 1;
  }

  static final int convertToPixels(float paramFloat1, String paramString, boolean paramBoolean, float paramFloat2, ContainerWrapper paramContainerWrapper, ComponentWrapper paramComponentWrapper)
  {
    UnitValue localUnitValue = (UnitValue)(paramBoolean ? HOR_DEFS : VER_DEFS).get(paramString);
    return localUnitValue != null ? Math.round(paramFloat1 * localUnitValue.getPixels(paramFloat2, paramContainerWrapper, paramComponentWrapper)) : -87654312;
  }
  ...
  public static final void setButtonOrder(String paramString)
  {
    BUTTON_FORMAT = paramString;
    MOD_COUNT += 1;
  }

  static final String getTagForChar(char paramChar)
  {
    switch (paramChar)
    {
    case 'o':
  ...
  static BoundSize getDefaultComponentGap(ComponentWrapper paramComponentWrapper1, ComponentWrapper paramComponentWrapper2, int paramInt, String paramString, boolean paramBoolean)
  {
    if (GAP_PROVIDER != null)
      return GAP_PROVIDER.getDefaultGap(paramComponentWrapper1, paramComponentWrapper2, paramInt, paramString, paramBoolean);
    if (paramComponentWrapper2 == null)
      return null;
    return (paramInt == 2) || (paramInt == 4) ? RELATED_X : RELATED_Y;
  }
  ...
  public static final void setDefaultHorizontalUnit(int paramInt)
  {
  ...
  public static final void setDefaultVerticalUnit(int paramInt)
  {
    if ((paramInt < 0) || (paramInt > 27))
      throw new IllegalArgumentException("Illegal Unit: " + paramInt);
 ...
 * Qualified Name:     net.miginfocom.layout.PlatformDefaults
