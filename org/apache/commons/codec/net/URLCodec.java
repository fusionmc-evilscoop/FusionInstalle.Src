...
/*     */         try {
/* 174 */           i++; int u = Utils.digit16(bytes[i]);
/* 175 */           i++; int l = Utils.digit16(bytes[i]);
...
/*     */     try
/*     */     {
/* 245 */       return encode(pString, getDefaultCharset()); } catch (UnsupportedEncodingException e) {
/*     */     }
...
/*     */     try
/*     */     {
/* 287 */       return decode(pString, getDefaultCharset()); } catch (UnsupportedEncodingException e) {
/*     */     }
...
/* 307 */       return encode((byte[])(byte[])pObject);
...
/* 332 */       return decode((byte[])(byte[])pObject);
