...
/* 184 */       if (b == 61)
/*     */         try {
/* 186 */           i++; int u = Utils.digit16(bytes[i]);
/* 187 */           i++; int l = Utils.digit16(bytes[i]);
...
/*     */     try
/*     */     {
/* 256 */       return encode(pString, getDefaultCharset()); } catch (UnsupportedEncodingException e) {
/*     */     }
...
/*     */     try
/*     */     {
/* 300 */       return decode(pString, getDefaultCharset()); } catch (UnsupportedEncodingException e) {
/*     */     }
...
/* 320 */       return encode((byte[])(byte[])pObject);
...
/* 345 */       return decode((byte[])(byte[])pObject);
