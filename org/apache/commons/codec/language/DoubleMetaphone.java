...
/*  299 */       result.append('X');
/*  300 */       index += 3; } else {
/*  301 */       if ((contains(value, index, 2, "CC")) && ((index != 1) || (charAt(value, 0) != 'M')))
/*      */       {
...
/*  835 */       return false;
/*      */     }
/*  837 */     return !contains(value, 0, 5, "CHORE");
/*      */   }
/*      */ 
...
/*      */     }
/*      */ 
/*  865 */     return ((contains(value, value.length() - 2, 2, "AS", "OS")) || (contains(value, value.length() - 1, 1, "A", "O"))) && (contains(value, index - 1, 4, "ALLE"));
/*      */   }
/*      */ 
...
/*      */ 
/* 1039 */     public DoubleMetaphoneResult(int maxLength) { this.maxLength = maxLength; }
/*      */ 
