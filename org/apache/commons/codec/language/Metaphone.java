...
/* 142 */         n++;
/*     */       } else {
/* 144 */         switch (symb) { case 'A':
/*     */         case 'E':
/*     */         case 'I':
/*     */         case 'O':
/*     */         case 'U':
/* 146 */           if (n != 0) break;
/* 147 */           code.append(symb); break;
/*     */         case 'B':
...
/*     */             break;
/*     */           }
/* 236 */           if (!isVowel(local, n + 1)) break;
/* 237 */           code.append('H'); break;
/*     */         case 'F':
/*     */         case 'J':
/*     */         case 'L':
/*     */         case 'M':
...
/*     */         case 'K':
/* 249 */           if (n > 0) {
/* 250 */             if (isPreviousChar(local, n, 'C')) break;
