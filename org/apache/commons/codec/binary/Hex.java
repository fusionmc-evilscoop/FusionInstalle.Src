...
/*     */     try
/*     */     {
/* 205 */       return decodeHex(new String(array, getCharsetName()).toCharArray()); } catch (UnsupportedEncodingException e) {
/*     */     }
...
/*     */     try
/*     */     {
/* 226 */       char[] charArray = (object instanceof String) ? ((String)object).toCharArray() : (char[])(char[])object;
/* 227 */       return decodeHex(charArray); } catch (ClassCastException e) {
/*     */     }
...
/*     */     try
/*     */     {
/* 272 */       byte[] byteArray = (object instanceof String) ? ((String)object).getBytes(getCharsetName()) : (byte[])(byte[])object;
/* 273 */       return encodeHex(byteArray);
/*     */     } catch (ClassCastException e) {
/* 275 */       throw new EncoderException(e.getMessage(), e); } catch (UnsupportedEncodingException e) {
/*     */     }
