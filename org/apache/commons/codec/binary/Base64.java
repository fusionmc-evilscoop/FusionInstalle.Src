...
/*      */ 
/*  468 */         if (this.encodeTable != STANDARD_ENCODE_TABLE) break;
/*  469 */         this.buffer[(this.pos++)] = 61;
/*  470 */         this.buffer[(this.pos++)] = 61; break;
/*      */       case 2:
...
/*      */ 
/*  479 */         if (this.encodeTable != STANDARD_ENCODE_TABLE) break;
...
/*  706 */       return decode((byte[])(byte[])pObject);
...
/*      */   {
/*  785 */     return encodeBase64(binaryData, isChunked, urlSafe, 2147483647);
/*      */   }
/*      */ 
...
/*      */     }
/*  906 */     return encode((byte[])(byte[])pObject);
/*      */   }
/*      */ 
